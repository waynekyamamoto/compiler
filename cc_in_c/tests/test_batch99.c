...
void test_sizeof_struct() {
  // sizeof(struct SmallStruct) should be 16 (2 fields * 8)
  int arr1[sizeof(struct SmallStruct)];
  check(sizeof(struct SmallStruct) == 16, "sizeof(struct SmallStruct) == 16");

  // sizeof(struct BigStruct) should be 40 (5 fields * 8)
  check(sizeof(struct BigStruct) == 40, "sizeof(struct BigStruct) == 40");

  // sizeof(int) should be 8 (our compiler uses 8-byte ints)
  ...
  // sizeof(int[5]) should be 40
  check(sizeof(int[5]) == 40, "sizeof(int[5]) == 40");
}
